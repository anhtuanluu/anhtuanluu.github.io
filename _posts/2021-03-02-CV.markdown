...
:   ### ELCOM - AI Enginneer
    ...
    Build, improve and maintain the real time plate detection model include plate detection and plate character recognition tasks, ensure the accuracy is higher than 95% and can run in embedded system like Jetson Xavier, TX2.
    ...
    Develop algorithms, use image processing for anomaly detection system in traffic. 
    ...
    EDA data and build machine learning model to classify students by class.
    ...
    Train new staffs with machine learning/deep learning knowlegde.
...
Experience with common databases such as MySQL, SQL server, PostgreSQL, mongoDB, arrangDB, Elastic search, Redis, Neo4j.
...
------------------------
---
[Tensorflow Developver Certificate](https://www.credential.net/be420993-5a9e-4e1b-a84c-5e609c68230c)
